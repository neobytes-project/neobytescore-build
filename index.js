...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-neobytes/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-neobytes -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-neobytes -o bitcore-lib-neobytes.js';
    }
